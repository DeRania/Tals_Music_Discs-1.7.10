...
public class UpdateSuccess
{
    ...
    {
        event.player.addChatMessage(new ChatComponentText(updateInfo.updateLN1));
        event.player.addChatMessage(new ChatComponentText(updateInfo.updateLN2 + " " + ChatFormatting.DARK_PURPLE + updateInfo.updateArray[0]));
    }
}
